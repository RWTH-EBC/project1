...
# @Last Modified time: 2021-03-01 20:15:55
...
def example_generate_simple_district_building(prj, nr_of_bldg):
    ...
    for bldg in prj.buildings:
        ...
        bldg.thermal_zones[0].use_conditions.infiltration_rate = 0.4
        ...
        bldg.thermal_zones[1].use_conditions.infiltration_rate = 0.4
