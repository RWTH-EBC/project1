...
def example_generate_simple_district_building(prj, nr_of_bldg):
    ...
    for bldg_number in range(1, nr_of_bldg + 1):
        ...
        bldg = prj.add_residential(
            ...
            name="SimpleDistrictBuilding_2010_{}".format(bldg_number),
        ...
        layers_iw = [
            ["GypsumPlasterForFinishing", 0.02, 975, 0.6, 0.84, 0.65, 0.9],
            ["MediumMasonryForInteriorApplications", 0.1, 1400, 0.54, 0.84, 0.55, 0.9],
            ["GypsumPlasterForFinishing", 0.02, 975, 0.6, 0.84, 0.65, 0.9],
        ]
...
if __name__ == "__main__":
    ...
    prj.name = "Simple_District_Retrofit2010_Destest_AixLib"
